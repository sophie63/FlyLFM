...
saving_path = '/media/sophie/470fddca-e336-42c7-9d91-b91361d994ea/toy_datasets/100632series'

path_list = ['/media/sophie/470fddca-e336-42c7-9d91-b91361d994ea/toy_datasets/100632/100632ss1',
             '/media/sophie/470fddca-e336-42c7-9d91-b91361d994ea/toy_datasets/100633/100633ss1',
             '/media/sophie/470fddca-e336-42c7-9d91-b91361d994ea/toy_datasets/100634/100634ss1']
...
ni2_imgs = (nib.Nifti2Image.from_image(nib.load(img)) for img in data_list)
print "finished reading files..."
ni2_concat = nib.concat_images(ni2_imgs, check_affines=False, axis=3)
print "finished concatenation, saving..."
ni2_concat.to_filename(saving_path+series_name+'on.nii')
...
for i in range(1,len(idx_list)):
    ...
    subprocess.call(["matlab -nosplash -nodisplay -r \"pipeline_dFF_psf_KF(\'%s\')\""%(file_name)], shell=True)
