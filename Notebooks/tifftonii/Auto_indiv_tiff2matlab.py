...
for path in path_list:
    ...
    sio.savemat(saving_path+'/'+Dataname+'_TimeFluoOn.mat', {'TimeFluoOn':TimeOnFinal})
    

    TotalTimeOn=Toff-Tinit
    sio.savemat(saving_path+'/'+Dataname+'_TotalTimeOn.mat', {'TotalTimeOn':TotalTimeOn})
    ...
    fn = saving_path+Dataname+'on.nii'
    data_list.append(fn)
    nib.save(nim,fn)
...
for i,fn in enumerate(data_list):
    ...
    file_name = saving_path+path_list[i].split('/')[-1][:6]+'reg.nii'
